...
def call_all(callable_object_list):
    for f in callable_object_list:
        f()
...
class ModelTrainer:
    ...
    def __init__(self, loss_fn, epochs, optimizer, device=torch.device('cpu')):
        """
    ...
    def run(self, model, training_set, training_callback=None, validation_set=None):
        """
        Runs a complete training on model.
        """
    ...
    def add_batch_training_callback(self, callback):
        """ 
