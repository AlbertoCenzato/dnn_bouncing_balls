...
class ConvLSTMCell(nn.Module):
    ...
    def __init__(self, input_size, input_dim, hidden_dim, kernel_size, bias: bool,
                 hidden_activation=torch.sigmoid, output_activation=torch.tanh):
        """
        :param input_size: Tuple[int, int]. Height and width of input tensor as (height, width)
        :param input_dim: int. Number of channels of input tensor
        :param hidden_dim: int. Number of channels of hidden state
        :param kernel_size: Tuple[int, int]. Size of the convolutional kernel
...
class ConvLSTM(nn.Module):
    ...
    def __init__(self, input_size, input_dim, hidden_dim, kernel_size, num_layers,
                 batch_first=False, bias=True, mode='sequence'):
    ...
    def set_mode(self, mode):
        """
        :param mode: str. Either 'sequence' or 'step-by-step'
        :return: str. Old mode
        """
        old_mode = self.mode
        self.mode = mode
    ...
    def _forward_sequence(self, input, hidden_state=None):
        """
        :param input: torch.Tensor
        :param hidden_state: Tuple[List[torch.Tensor], List[torch.Tensor]]
        :return: Tuple[torch.Tensor, Tuple[List[torch.Tensor], List[torch.Tensor]]]
    ...
    def _forward_item(self, input, hidden_state):
        """
        :param input: torch.Tensor
        :param hidden_state: Tuple[List[torch.Tensor], List[torch.Tensor]]
        :return: Tuple[torch.Tensor, Tuple[List[torch.Tensor], List[torch.Tensor]]]
    ...
    def init_hidden(self, batch_size):
        """
        :param batch_size: int
        :return: Tuple[List[torch.Tensor], List[torch.Tensor]]
        """
        h_0, c_0 = [], []
    ...
    def _extend_for_multilayer(param, num_layers):
        """
        :param param:
        :param num_layers:  List[int] or int
        :return: List[int]
        """
